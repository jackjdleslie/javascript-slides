...
- In the browser, you are interacting with APIs provided by the browser, e.g window
...
Browser
- Browsers provide a lot of APIs to work with, the most common ones being window and document
